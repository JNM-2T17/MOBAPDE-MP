 ...
 * {@link SelectArtistFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SelectArtistFragment#newInstance} factory method to
...
public class SelectArtistFragment extends Fragment {
    ...
    public static SelectArtistFragment newInstance() {
        SelectArtistFragment fragment = new SelectArtistFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_select_artist, container, false);
